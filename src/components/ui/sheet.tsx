...
function SheetOverlay({
  ...
  return (
    <SheetPrimitive.Overlay
      ...
      className={cn(
        "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 bg-black/80 duration-100 data-[state=closed]:animate-out data-[state=open]:animate-in data-ending-style:opacity-0 data-starting-style:opacity-0 supports-[backdrop-filter]:backdrop-blur-xs",
        className,
      )}
      {...props}
    />
